...
-- Staff-console synthetic-data boundary. Operational dashboards exclude these
-- by default but the Accounts page can deliberately include them for support.
...
create trigger cascade_account_test_marker_trigger after update of test_marker on accounts for each row execute function cascade_account_test_marker();
