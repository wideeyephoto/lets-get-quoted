...
replacements = [
    ...
    ("Please choose how  may follow up about your request.", "t.chooseFollowUp(site.company_name || 'we')"),
    ...
    ('"We\\'ve received your request! Our team is already reviewing your details."', "t.receivedRequest"),
    ...
    ("'What a real customer sees here — yours wasn\\'t sent.'", "t.whatRealCustomerSees"),
    ...
    ("Add more photos (/)", "t.addMorePhotos(selectedPhotos.length, MAX_PHOTOS)"),
    ("'📸 Add job photos'", "t.addJobPhotos"),
    ("Remove ", "t.removePhoto(photo.name)"),
    (">Heads up: ", ">{t.headsUp} "),
...
import_str = "import { HeroQuickFormTranslations } from './HeroQuickFormTranslations';\n"
if "HeroQuickFormTranslations" not in content:
    content = import_str + content

hook_str = "  const smartIntakeActive = wizardEnabled && !classicFallback;\n"
if "const t =" not in content:
    content = content.replace(hook_str, hook_str + "  const t = site.language === 'es' ? HeroQuickFormTranslations.es : HeroQuickFormTranslations.en;\n")
