create function public.quick_stop_deployment_pause() returns trigger language plpgsql security invoker set search_path = '' as $$ begin raise exception 'Quick Stop is briefly unavailable during a release. Please retry shortly.' using errcode='55000'; end; $$;
