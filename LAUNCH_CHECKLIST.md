...
- [ ] **Margin recovery and release:** Recover cost writes interrupted before evaluation; verify cost-writer concurrency, migration order, background pickup and actual inbox delivery.
