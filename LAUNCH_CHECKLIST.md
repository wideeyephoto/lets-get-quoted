...
- [x] **Pentest Finding F1 Remediation & Runtime Function ACL CI Sweep (2026-09-14):**
  ...
  - **Deployment Status:** Forward migration `20260914170000_revoke_and_guard_unguarded_security_definer_rpcs.sql` is ready to apply to production/staging upon deployment go-ahead.
