...
- [ ] **Remaining production sign-off:** Deploy and rehearse the patch through LGQ, prove a pending website certificate transition and disposable deletion through the deployed app credentials, complete Outlook/additional message and failure scenarios, then observe the controlled production canary. No production email-domain tenant or rollout flag was activated. Full scope and residual gates are recorded in the report and [email go-live list](docs/contractor-email-domain-go-live-checklist-2026-09-09.md).
