...
- [ ] **Quote-option release acceptance:** Apply the transaction migration before callers, drain old writers, add form request/revision identity and verify payment/plan concurrency plus hosted delivery.
