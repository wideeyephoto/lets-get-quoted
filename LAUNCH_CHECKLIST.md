...
- [x] **R09 (Storage & Capacity):** Evidence: [R09-storage-migration-20260910.log](docs/R09-storage-migration-20260910.log), [R09-pg17-storage-20260910.log](docs/R09-pg17-storage-20260910.log). Office Data API confidentiality fixes implemented and staging-verified; see [tenant-office-access-fixes-2026-09-09.md](docs/tenant-office-access-fixes-2026-09-09.md). Production release pending.
...
- [ ] **Prove what the now-sellable office seat actually buys (FIXES STAGING-VERIFIED; PRODUCTION RELEASE PENDING 2026-09-09):** The production audit found three access defects. Their fixes pass **44/44 real staging browser/API cases**, including positive owner/office controls and retained-session revocation. Production rollout, its signed-in recheck and the broader surface matrix remain open. See [fix evidence and release order](docs/tenant-office-access-fixes-2026-09-09.md).
- [ ] **Re-verify tenant isolation against the frozen SHA (FAILED 2026-09-09):** Real sessions were tested on production `8a7b129ac4dd68467532cb384da78d5203135a18`. Foreign reads and tenant reassignment were denied, but an A job could be linked to B's client. Fix the confirmed relationship boundary and financial API failures, re-run the signed-in harness, and complete the remaining broader matrix. The earlier 83-case sign-off is withdrawn.
