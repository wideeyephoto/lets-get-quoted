...
- [ ] **Live sending gate:** Gmail and Outlook transport delivery/authentication, replies, and the corrected production quote link are proven. The BrokePipes-only release is deployed; product enrollment, DNS verification, and clean disconnect/reconnect passed. A real custom-domain product send, remaining failure drills, website TLS promotion/deployed cleanup, and seven-day observation remain open; see the [current canary record](docs/contractor-domains-canary-2026-09-09.md).
