...
import { updateExtraStopSettingsAction } from '../settings/actions';
...
export default function ExtraStopConfigurator({
  extraStop,
  refundTiers,
  stripeConnected,
}: {
  extraStop: ExtraStopSettingsRow;
  ...
  return (
    <section className="panel workspace-section-card" id="extra-stop-setup">
      <div className="section-heading workspace-section-heading compact-heading">
        <p className="eyebrow">Setup</p>
        <h2>How Extra Stops work for you</h2>
      </div>

      <p className="workspace-details-copy" style={{ marginTop: 0 }}>
        Extra Stop is a separate, faster path alongside normal booking. A customer asks to be fitted in
      ...
      <p className="workspace-details-copy extra-stop-when-note">
        <strong>An Extra Stop can land mid-day or at the end of the day</strong> — wherever it fits your
      ...
      {!stripeConnected ? (
        <div className="automation-prereq" style={{ marginBottom: '0.9rem' }}>
          ...
          <span>
            Extra Stop collects the fee before the visit — <Link href="/dashboard/settings#payments">connect Stripe</Link> to
          ...
          >
            ...
            <div className="bset-section-body" hidden={!isOpen(section.key)}>
                {section.key === 'when' ? (
                  <div className="form-grid compact-form">
                    <div className="field full">
                      ...
                      <small className="field-hint">Clear them all to pause Extra Stop without switching it off.</small>
                    </div>

                    <div className="field full">
                      <RangeSlider
                        label="Arrival windows can run between"
                        nameMin="extraStopEarliest"
                        nameMax="extraStopLatestEnd"
                        min={0}
                        max={1440 - 15}
                        step={15}
                        ...
                        hint="No Extra Stop will be offered a window outside these hours."
                      />
                    </div>
                  </div>
                ) : null}
                ...
                {section.key === 'what' ? (
                  <div className="form-grid compact-form">
                    <div className="field full">
                      <label htmlFor="extraStopCategories">Types of work you’ll take as an Extra Stop</label>
                      <input
                        id="extraStopCategories"
                        name="extraStopCategories"
                      ...
                      <small className="field-hint">
                        ...
                        sent to a normal booking request instead of an Extra Stop.
                        <br />
                    ...
                    <div className="field">
                      <label htmlFor="extraStopMaxVisitMinutes">Longest visit you’ll squeeze in (minutes)</label>
                    ...
                    <div className="field">
                      <label htmlFor="extraStopRequiredPhotos">Photos the customer must send</label>
                    ...
                    <p className="field full field-hint extra-stop-always-on">
                      <span aria-hidden="true">🛡</span> Every Extra Stop request is screened by the AI
                      eligibility check before it reaches you — complex, unsafe or out-of-scope jobs never
                      become an Extra Stop. That isn&apos;t optional: you&apos;re quoting a price and taking
                ...
                {section.key === 'charge' ? (
                  <div className="form-grid compact-form">
                    <div className="field full">
                      <RangeSlider
                        label="Extra Stop fee range"
                        nameMin="extraStopMinFee"
                        nameMax="extraStopMaxFee"
                        min={0}
                        max={1000}
                        step={5}
