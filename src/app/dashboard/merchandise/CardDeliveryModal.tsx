        ...
        <div className={styles.modalHeader}>
          <div>
            ...
            <p className={styles.modalSubtitle}>
              Your approved business cards will be dispatched via UPS Ground with live tracking.
            </p>
          </div>
          <button
            type="button"
          ...
          <div className={styles.modalFooter} style={{ marginTop: '0.5rem' }}>
            ...
            >
              {isSubmitting ? (
                ...
                <>
                  <Lock size={14} />
                  <span>Pay with Stripe (${totalDollars.toFixed(2)})</span>
                  <ArrowRight size={14} />
                </>
              )}
            </button>
