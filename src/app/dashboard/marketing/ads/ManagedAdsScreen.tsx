...
import NeighborhoodHaloDashboardTab from './NeighborhoodHaloDashboardTab';
...
type Props = {
  ...
  basePath?: string;
  initialTab?: string;
  initialHaloSettings?: HaloSettingsRecord;
  initialHaloCampaigns?: HaloCampaignRecord[];
  completedJobsForHalo?: Array<{ id: string; ref: string; address?: string | null; quoted_amount?: number; photo_paths?: string[] }>;
};
...
export default function ManagedAdsScreen({
  ...
  initialTab,
  initialHaloSettings,
  initialHaloCampaigns,
  completedJobsForHalo,
}: Props) {
    ...
    <main className="dashboard-page workspace-page mkt-page">
      ...
      {showManagementConsole ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', marginBottom: '2rem' }}>
          ...
          {managementTab === 'halo' ? (
            <NeighborhoodHaloDashboardTab
              businessName={businessName}
              trade={trade}
              city={city}
              domain={domain}
              initialSettings={initialHaloSettings}
              initialCampaigns={initialHaloCampaigns}
              completedJobs={completedJobsForHalo}
            />
          ) : null}
        </div>
      ) : null}
