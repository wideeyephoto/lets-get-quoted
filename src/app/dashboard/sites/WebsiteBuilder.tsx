              ...
              <div className={styles.formSection}>
                ...
                <SectionCard title="Hero badges" description="The floating trust chips on and beside your hero photo." open={openSection === 'heroBadges'} onToggleOpen={() => toggleSection('heroBadges')}>
                  ...
                  <div className={styles.formField}>
                    ...
                    <small className={styles.fieldHint}>Up to {MAX_EXTRA_HERO_BADGES} more chips, shown as a row under your hero text — so your page can show up to 5 badges in total.</small>
                  </div>
                </SectionCard>
