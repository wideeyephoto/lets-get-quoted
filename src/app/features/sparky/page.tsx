...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes! Let’s Get Quoted includes customizable AI companions tailored to your style and trade—including Sparky ⚡ (Contractor AI Sidekick), Diesel 🔨 (Jobsite Foreman), Echo 🦉 (Code & Safety Auditor), and AI Assistant 💡 (Modern Energy Spark). You can switch between them anytime in your dashboard.',
  },
  {
...
export default function SparkyFeaturePage() {
  return (
    <FeatureDetailLayout
      ...
      lede="Text or call your Copilot from the truck, or open it when you walk up to an estimate. Tell it everything you’re thinking—it calculates the math, updates active job files, files site photos, tracks unpaid invoices, and sets reminders. Plus, choose from customizable companions like Sparky, Diesel, and Echo."
