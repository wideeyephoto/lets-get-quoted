    ...
    >
      ...
      <section className="section-block" style={{ margin: '48px 0', background: 'var(--bg-elevated)', padding: '2rem', borderRadius: '12px', border: '1px solid var(--line)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem', marginTop: '1.5rem' }}>
          <div style={{ padding: '1rem', background: 'var(--bg-elevated)', borderRadius: '8px', border: '1px solid var(--line)' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--accent, #1d4ed8)', textTransform: 'uppercase' }}>Style 01</span>
            <h3 style={{ margin: '0.25rem 0', fontSize: '1rem', fontWeight: 700, color: 'var(--text)' }}>Clean Minimal</h3>
            <p style={{ fontSize: '0.8125rem', color: 'var(--muted)', margin: 0 }}>Streamlined, distraction-free inputs with zero visual friction for high conversion.</p>
          </div>
          <div style={{ padding: '1rem', background: 'var(--bg-elevated)', borderRadius: '8px', border: '1px solid var(--line)' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--gold-ink, #047857)', textTransform: 'uppercase' }}>Style 02</span>
            <h3 style={{ margin: '0.25rem 0', fontSize: '1rem', fontWeight: 700, color: 'var(--text)' }}>Compact Stepper</h3>
            <p style={{ fontSize: '0.8125rem', color: 'var(--muted)', margin: 0 }}>Step-by-step micro-stepper with progress indicators for detailed trade scopes.</p>
          </div>
          <div style={{ padding: '1rem', background: 'var(--bg-elevated)', borderRadius: '8px', border: '1px solid var(--line)' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--accent-2, #6d28d9)', textTransform: 'uppercase' }}>Style 03</span>
            <h3 style={{ margin: '0.25rem 0', fontSize: '1rem', fontWeight: 700, color: 'var(--text)' }}>Card-Based Grid</h3>
            <p style={{ fontSize: '0.8125rem', color: 'var(--muted)', margin: 0 }}>Visual tile selectors with custom trade icons and 1-click preset suggestions.</p>
          </div>
          <div style={{ padding: '1rem', background: 'var(--bg-elevated)', borderRadius: '8px', border: '1px solid var(--line)' }}>
            <span style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--flare, #c2410c)', textTransform: 'uppercase' }}>Style 04</span>
            <h3 style={{ margin: '0.25rem 0', fontSize: '1rem', fontWeight: 700, color: 'var(--text)' }}>AI Conversational</h3>
            <p style={{ fontSize: '0.8125rem', color: 'var(--muted)', margin: 0 }}>Interactive conversational flow with photo uploads &amp; multimodal vision analysis.</p>
          </div>
        </div>

        <p style={{ marginTop: '1.5rem', fontSize: '0.875rem' }}>
          Want to see how photos turn into material pick-lists?{' '}
          <Link href="/features/ai-vision" style={{ fontWeight: 700, color: 'var(--accent, #1d4ed8)' }}>
