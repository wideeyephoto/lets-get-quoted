...
export default function CrewFeaturePage() {
  return (
    <SuiteFeaturePage
      ...
      primary={{ label: 'See crew management in the demo', href: '/demo/crew' }}
      demo={
        <ExampleFrame
    ...
    >
      <section className="section-block" style={{ margin: '48px 0' }}>
        <div>
          <p className="eyebrow">Automated Morning Dispatch &amp; Equipment Loadouts</p>
        ...
        <div style={{ marginTop: '1.25rem' }}>
          <a
            ...
            style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: 700, color: 'var(--accent)', textDecoration: 'none' }}
          >
