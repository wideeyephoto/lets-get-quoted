...
export default function AiVoicePage() {
  return (
    <FeatureDetailLayout
      ...
      primary={{ label: 'Start free on Flex', href: 'https://app.letsgetquoted.com/start?goal=feature&feature=ai_intake&source=feature_page' }}
    ...
    >
      <FaqList
        ...
        title="Frequently asked questions about AI Voice Dispatcher."
        id="voice-faq"
      />
    </FeatureDetailLayout>
  );
