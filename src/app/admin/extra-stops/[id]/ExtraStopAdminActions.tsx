...
import { adminRefundExtraStopAction, adminResolveExtraStopAction } from './actions';

export default function ExtraStopAdminActions({
  requestId,
  canRefund,
  feeLabel,
}: {
  ...
  return (
    <section className={styles.panel}>
      ...
      {canRefund ? (
        <form action={adminRefundExtraStopAction.bind(null, requestId)} className={styles.formStack}>
      ...
      <form action={adminResolveExtraStopAction.bind(null, requestId)} className={styles.formStack}>
