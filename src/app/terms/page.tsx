  ...
  return (
    <main className={styles.legalShell} id="main-content">
      ...
      <div className={styles.legalContent}>
        ...
        <section>
          <h2>4. AI Tools, AI Voice Receptionist &amp; Automated Outputs</h2>
          <p>
            The Service incorporates generative artificial intelligence, natural language processing, and automated telephony
            tools, including our AI Voice Receptionist, automated draft generators, and customer intake assistants.
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>No Emergency Calling (No 911):</strong> The AI Voice Receptionist and platform telephony do NOT support 911
              or emergency service calling. You must not configure or represent the Service as an emergency dispatch system.
            </li>
            <li>
            ...
            <li>
              <strong>Drafts &amp; Suggestions (Human Review Required):</strong> AI-generated quotes, emails, text drafts, permit
              notes, and voice summaries are computer-generated suggestions. They may contain inaccuracies or hallucinations. You
              are solely responsible for reviewing, verifying, and approving all AI-generated drafts before communicating them to
              homeowners or third parties.
            </li>
          </ul>
        </section>
