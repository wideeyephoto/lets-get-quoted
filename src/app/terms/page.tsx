  ...
  return (
    <main className={styles.legalShell} id="main-content">
      ...
      <div className={styles.legalContent}>
        ...
        <section>
          <h2>4. AI Tools, Sparky AI Sidekick &amp; Field Telephony</h2>
          <p>
            The Service incorporates generative artificial intelligence, multimodal analysis, and automated telephony
            tools, including our in-app and SMS assistant <strong>Sparky</strong>, our 24/7 AI Voice Receptionist/Dispatcher,
            and Text-to-Job field ingestion.
          </p>
          <ul>
            <li>
              <strong>Sparky Field Interactions &amp; Text-to-Job:</strong> Contractors may transmit job notes, voice memos,
              scope summaries, punch list tasks, and project photos to Sparky via SMS, MMS, or in-app voice/chat to update job
            ...
            <li>
              ...
              Social Security numbers, or confidential financial credentials to Sparky via SMS or voice notes.</strong> All customer
            ...
            <li>
              <strong>No Emergency Calling (No 911):</strong> Sparky, the AI Voice Receptionist, and platform telephony do NOT support
            ...
            <li>
              ...
              calculations, emails, text drafts, permit notes, and voice summaries generated by Sparky are computer-generated
