    ...
    <div className={styles.tourContainer}>
      ...
      <div className={styles.perspectiveHeroSummary}>
        <div className={styles.perspectiveHeroInner}>
          ...
          <a
            href={signupUrl}
            onClick={() => trackDemoEvent('signup_clicked', { source: 'tour_complete_banner' })}
      ...
      <div className={styles.cardLayout}>
        <div className={styles.panelCard} style={{ textAlign: 'center', maxWidth: '820px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '16px', color: '#b2c7d3', lineHeight: '1.6', margin: '0 auto 36px', maxWidth: '640px' }}>
            In 5 minutes, you saw how {DEMO_TOUR_CUSTOMER.name}&apos;s ${DEMO_TOUR_JOB.totalWithUpgrade.toLocaleString()} paver patio project moved from a website visit to an e-signed quote with a $500 deposit in your bank.
          </p>
          ...
          >
            ...
            <div style={{ background: '#040d14', border: '1px solid rgba(255, 209, 102, 0.3)', borderRadius: '8px', padding: '14px' }}>
              ...
              <small style={{ color: '#8faab7', fontSize: '11.5px' }}>+ Hardscape lighting</small>
            </div>
