    ...
    <div className={styles.sandboxCard}>
      <div className={styles.header}>
        <div className={styles.badgeRow}>
          ...
          <span className={styles.phoneLabel}>Dispatch Line: {DISPLAY_HOTLINE}</span>
        </div>
        <h3 className={styles.title}>Test it from your own phone right now.</h3>
        <p className={styles.subtitle}>
          Tap any trade scenario below. On mobile, tap <strong>Open in Messages</strong> to send a pre-filled test. On desktop, scan or copy the hotline to try it.
        </p>
      </div>
      ...
      <div className={styles.previewBox}>
        <div className={styles.previewHead}>
          <span className={styles.previewTo}>To: <strong>Job Dispatch Hotline {DISPLAY_HOTLINE}</strong></span>
