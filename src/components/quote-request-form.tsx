  ...
  return (
    <form ref={formRef} className={styles.form} onSubmit={handleSubmit} data-edit="quoteForm">
      ...
      <div ref={projectStepRef} className={styles.step} hidden={step !== 0} role="group" aria-label="Your project" onKeyDown={handleProjectKeyDown}>
        <label className={`${styles.field} ${styles.wide}`}><span>Tell us about the project</span><textarea name="message" maxLength={3000} required placeholder={siteContent.quoteFormPlaceholder?.trim() || "Tell us what you need done, any problem areas or details, and your ideal timing. The more you share, the faster we can get you an accurate quote."} /></label>
