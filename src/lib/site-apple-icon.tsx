...
//
// Lives in lib because BOTH tenant route trees need it. siteIconsMetadata emits
// <link rel="apple-touch-icon" href="/apple-icon"> for every site, subdomain or
// custom domain — but the route existed only under /site/[subdomain], so on a
// contractor's own domain that link 404'd and iOS fell straight back to the SVG
// favicon. That is precisely the white square this file was written to prevent.
...
export async function renderSiteAppleIcon(site: Site | null): Promise<Response> {
