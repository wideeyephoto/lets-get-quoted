    ...
    features: [
      {
        ...
        desc: 'In-app AI assistant with live screen awareness and customizable trade avatars (Sparky, Diesel, Echo, and Energy Orbit). Text site photos, notes, and voice memos—your copilot sorts them to the right job and reminds you later.',
