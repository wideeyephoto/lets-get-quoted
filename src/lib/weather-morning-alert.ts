...
export function buildMorningWeatherAlertText(params: {
  ...
  return `Morning Weather Alert (6:45 AM): Today's forecast (${reasonSummary}) threatens ${jobText} for ${businessName}: ${nameSummary}. Review and 1-tap reschedule before crews roll: ${scheduleUrl}`;
}
