    ...
    standardSupplements: [
      {
        ...
        aliases: ['drip edge', 'eave metal', 'rake metal', 'roof edge metal', 'edge flashing'],
        unit: 'LF',
        defaultQty: 130,
        defaultUnitPrice: 5,
      },
      {
        ...
        aliases: ['ice & water', 'ice and water', 'ice barrier', 'weather watch', 'winterguard', 'self-adhering underlayment'],
        unit: 'SQ',
        defaultQty: 4,
        defaultUnitPrice: 212.5,
      },
      {
        ...
        aliases: ['starter strip', 'starter shingles', 'starter course', 'universal starter'],
        unit: 'LF',
        defaultQty: 160,
        defaultUnitPrice: 3,
      },
      {
        ...
        aliases: ['ridge cap', 'hip and ridge', 'high-profile cap', 'hip & ridge', 'ridge shingles'],
        unit: 'LF',
        defaultQty: 65,
        defaultUnitPrice: 8,
      },
      {
        ...
        aliases: ['steep pitch', 'steep charge', 'high story', 'steep access', 'fall protection', 'pitch surcharge', 'steep roof'],
        unit: 'SQ',
        defaultQty: 25,
        defaultUnitPrice: 30,
      },
      {
        ...
        aliases: ['dumpster', 'debris removal', 'disposal fee', 'haul off', 'dump fee', 'waste removal', 'landfill'],
        unit: 'EA',
        defaultQty: 1,
    ...
    standardSupplements: [
      {
        ...
        aliases: ['crane', 'heavy rigging', 'crane pick', 'boom truck', 'remote rigging'],
        unit: 'HR',
        defaultQty: 8,
      ...
      },
      {
        ...
        aliases: ['tarping', 'emergency tarp', 'roof tarp', 'temporary tarp', 'mitigation tarp'],
        unit: 'EA',
        defaultQty: 1,
      ...
      },
      {
        ...
        aliases: ['debris haul', 'haul-off', 'wood chipping', 'chipping', 'haul away'],
        unit: 'LOAD',
        defaultQty: 2,
        defaultUnitPrice: 600,
      },
      {
        ...
        aliases: ['stump grinding', 'stump removal', 'grind stump', 'root ball grinding'],
        unit: 'IN',
        defaultQty: 25,
        defaultUnitPrice: 22,
      },
    ...
    standardSupplements: [
      {
        ...
        defaultEstimatedCost: 750,
        aliases: ['air scrubber', 'hepa scrubber', 'negative air', 'air filtration'],
        unit: 'DAY',
        defaultQty: 3,
      ...
      },
      {
        ...
        aliases: ['antimicrobial', 'biocide', 'microban', 'germicidal', 'disinfectant'],
        unit: 'SF',
        defaultQty: 500,
      ...
      },
      {
        ...
        defaultEstimatedCost: 650,
        aliases: ['baseboard removal', 'wall cavity', 'injection drying', 'cavity drying', 'air injection'],
        unit: 'LF',
        defaultQty: 65,
        defaultUnitPrice: 10,
      },
      {
        ...
        aliases: ['moisture map', 'moisture mapping', 'thermal imaging', 'psychrometric', 'flir'],
        unit: 'EA',
        defaultQty: 1,
