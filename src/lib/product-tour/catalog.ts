...
/**
 * Public platform overview definition.
 */
...
export const DASHBOARD_ORIENTATION_TOUR: TourDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      route: '/dashboard',
      targetId: 'nav:/dashboard/schedule',
    ...
    },
    {
      ...
      route: '/dashboard',
      targetId: 'nav:/dashboard/automations',
