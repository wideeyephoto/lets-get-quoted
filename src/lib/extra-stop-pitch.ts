// The message that tells past customers Extra Stops exist.
//
...
// "Extra Stop" is. What they recognise is "something broke and I'd rather not
...
export type ExtraStopPitch = { subject: string; body: string; sms: string };
...
export function buildExtraStopPitch(input: PitchInput): ExtraStopPitch {
