...
export const SMS_CATALOGUE: SmsCatalogueEntry[] = [
  ...
  },
  {
    ...
    title: 'Booking request receipt',
    trigger: 'A customer requests an arrival window on your booking page',
    audience: 'customer',
  ...
  {
    id: 'owner-booking-request-alert',
    title: 'New booking request alert',
    trigger: 'A customer submits an arrival window request',
    audience: 'owner',
    control: automation('booking', 'Online booking'),
  ...
  {
    id: 'owner-voice-call-notification',
    title: 'Voice call answered notification',
    trigger: 'An incoming call is answered and summarized by the AI receptionist',
    audience: 'owner',
    control: always('Call notification preference'),
    body: ownerVoiceCallNotificationText({
      businessName: SAMPLE.business,
