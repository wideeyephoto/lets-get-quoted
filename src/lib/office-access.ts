...
export const OFFICE_ROUTES: readonly OfficeRoute[] = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'Schedule',
    requires: Object.freeze(['jobs.read', 'schedule.write']),
  }),
  Object.freeze({
    href: '/dashboard/messages',
    label: 'Messages',
    requires: Object.freeze(['messages.read']),
  }),
  Object.freeze({
    href: '/dashboard/crew',
    label: 'Crew',
    requires: Object.freeze(['crew.read']),
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    label: 'Services',
    requires: Object.freeze(['jobs.read']),
  }),
  Object.freeze({
  ...
  Object.freeze({
    ...
    label: 'Import',
    requires: Object.freeze(['jobs.write', 'clients.write']),
  }),
  Object.freeze({
    href: '/dashboard/help',
    label: 'Help',
