...
export const FEATURE_CATEGORIES: FeatureCategory[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'publish-reminders', name: 'Publish reminders', desc: 'Gentle 2/4/8-week nudges to keep content fresh.' },
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'quote-followups', name: 'Automatic follow-ups', desc: 'Nudge un-approved quotes up to twice, then stop — hands-off.' },
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'reminders', name: 'Appointment reminders', desc: 'Day-before text or email; reply "C" to confirm.' },
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'payroll', name: 'Payroll', desc: 'Hours-and-pay rollups by crew member and period.' },
    ],
  },
  {
    num: '08',
  ...
  },
  {
    ...
    features: [
      ...
      { id: 'rebook', name: 'Rebook invites', desc: 'Nudge customers due for their next visit; one tap or batch.' },
