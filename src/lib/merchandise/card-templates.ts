...
export const BUSINESS_CARD_TEMPLATES: CardTemplateDefinition[] = [
  ...
  },
  {
    ...
    subtitle: 'Trust Crest & Verified Badge',
    tag: 'Homeowner Trust',
    tradeFit: 'Residential Services, Painting, Handyman, Security',
    description: 'Emphasizes homeowner trust with professional licensing details, upfront pricing indicators, and verified contact credentials.',
    frontFeature: 'Clean professional crest with license endorsement',
    backFeature: 'Clear written estimate guarantee with direct booking',
    recommendedFinish: 'foil_gold',
