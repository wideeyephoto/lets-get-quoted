...
export const COLOR_SCHEMES: ColorScheme[] = [
  ...
  {
    key: 'steel',
    label: 'Steel — slate grey + electric blue',
    tone: 'dark',
    status: 'active',
    mood: 'Mid · Slate',
    bg: '#1e242c',
  ...
  {
    key: 'sandstone',
    label: 'Sandstone — warm limestone + terracotta',
    tone: 'light',
    status: 'active',
    mood: 'Mid · Earthy',
    bg: '#e6e1d8',
  ...
  {
    key: 'copper',
    label: 'Copper — warm bronze + amber',
    tone: 'dark',
    status: 'active',
    mood: 'Mid · Bronze',
    bg: '#201a17',
  ...
  {
    key: 'concrete',
    label: 'Concrete — cool stone + ocean blue',
    tone: 'light',
    status: 'active',
    mood: 'Mid · Stone',
    bg: '#dde3ea',
  ...
  {
    key: 'tuxedo',
    label: 'Tuxedo — deep onyx + pure white',
    tone: 'light',
    status: 'active',
    mood: 'High Contrast · Onyx',
    bg: '#f4f4f6',
    surface: '#ffffff',
    ink: '#09090b',
    muted: '#52525b',
