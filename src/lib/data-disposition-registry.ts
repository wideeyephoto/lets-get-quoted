...
export const DATA_DISPOSITION_REGISTRY: Record<string, TableDisposition> = {
  ...
  client_owner_request_receipts: {
    tableName: 'client_owner_request_receipts', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  warranty_request_receipts: {
    tableName: 'warranty_request_receipts', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  ...
  quote_option_request_receipts: {
    tableName: 'quote_option_request_receipts', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  margin_evaluation_requests: {
    tableName: 'margin_evaluation_requests', relationship: 'direct_account_id', primaryKeyColumn: 'job_id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  ...
  platform_email_suppression: {
    tableName: 'platform_email_suppression', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot', vendorDependency: 'resend',
  },
  operational_callback_evidence: {
    tableName: 'operational_callback_evidence', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  email_recovery_control: {
    tableName: 'email_recovery_control', relationship: 'direct_account_id', primaryKeyColumn: 'id',
    localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  ...
  email_domain_restoration_snapshots: {
    tableName: 'email_domain_restoration_snapshots', relationship: 'fk_chain', primaryKeyColumn: 'notice_id',
    fkPath: ['notice_id', 'email_domain_restoration_notices.account_id'], localAction: 'delete', portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot', vendorDependency: 'resend',
  },
  ...
  email_domain_failure_snapshots: {
    ...
    primaryKeyColumn: 'notice_id',
    fkPath: ['notice_id', 'email_domain_failure_notices.account_id'],
    localAction: 'delete',
    portability: 'internal_system',
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  ...
  client_portal_access: {
    ...
    portability: 'redacted',
    exportRedactions: ['token_hash'],
    retention: { jurisdiction: 'GENERAL', legalBasis: 'transient_operational', durationDays: 90, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },
  ...
  billing_subscriptions: {
    ...
    localAction: 'retain_immutable',
    portability: 'redacted',
    exportRedactions: ['stripe_subscription_id', 'stripe_customer_id'],
    retention: { jurisdiction: 'US_FEDERAL', legalBasis: 'statutory_tax_7yr', durationDays: 2555, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
    vendorDependency: 'stripe',
  },
  ...
  quickbooks_connections: {
    ...
    localAction: 'delete',
    portability: 'redacted',
    exportRedactions: ['access_token', 'refresh_token', 'token_secret', 'client_secret'],
    retention: { jurisdiction: 'GENERAL', legalBasis: 'contractual_fulfillment', durationDays: 0, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  ...
  // Audited SMS consent evidence ledger for TCPA/10DLC compliance
  sms_consent_evidence: {
    tableName: 'sms_consent_evidence',
    relationship: 'direct_account_id',
    primaryKeyColumn: 'id',
    localAction: 'delete',
    portability: 'full',
    retention: { jurisdiction: 'US_FEDERAL', legalBasis: 'statutory_tax_7yr', durationDays: 1460, startEvent: 'account_closed' },
    legalHoldBehavior: 'block_disposal_preserve_snapshot',
  },

  // Contractor merchandise print on demand orders
  merchandise_orders: {
  ...
  // Human-in-the-loop operator action approval requests
  ai_operator_action_requests: {
    tableName: 'ai_operator_action_requests',
    relationship: 'system_global',
    primaryKeyColumn: 'id',
    localAction: 'retain_immutable',
    portability: 'internal_system',
