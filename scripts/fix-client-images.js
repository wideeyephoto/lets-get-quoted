...
let file = fs.readFileSync('src/lib/client-images.ts', 'utf8');
...
export async function compressImageWithDimensions(
  ...
  return {
    file: new File([blob], \`\${baseName || 'project-photo'}.webp\`, { type: 'image/webp' }),
    width: canvas.width,
...
fs.writeFileSync('src/lib/client-images.ts', file, 'utf8');
console.log('Fixed client-images.ts');
