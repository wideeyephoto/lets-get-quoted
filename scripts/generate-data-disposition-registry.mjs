...
add('sms_campaign_keyword_preferences', 'system_global', 'phone_number', undefined, 'retain_immutable', undefined, 'internal_system', undefined, 'US_FEDERAL', 'dispute_limitation', 1460, 'immediate', undefined, 'Campaign-wide STOP and START suppression state');
