...
/* The demo link carried a rule above it because it used to be the last row
   INSIDE the panel, and a divider was what stopped it reading as a seventh
   message. It sits under the phone now, beside the Replay control, where the
   same divider is a line hanging in space. (0,3,0) against the base rule's
   (0,2,0), so it wins without touching the pages that still nest it. */
.root :global(.hero-thread-sim .hero-thread-demo) {
  margin-top: 0;
  padding-top: 0;
  border-top: 0;
}
