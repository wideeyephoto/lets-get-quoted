...
/* Off the console's corners rather than the old column's sides. alertFloat is
   dropped for the same reason dashboardFloat was — it owns the transform, and
   the front plane needs it. */
.root :global(.hero-stage .floating-alert) {
  top: -24px; right: -12px; animation: none;
}
.root :global(.hero-stage .floating-paid) {
  bottom: 84px; left: -14px; animation: none;
}
...
@media (max-width: 1100px) {
  ...
  .root :global(.hero-stage .dashboard-card) { width: 100%; left: 0; height: 520px; }
