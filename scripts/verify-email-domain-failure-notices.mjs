...
try {
  ...
  await db.query(readFileSync(join(root, 'migrations/20260909212723_email_sending_domain_account_limit.sql'), 'utf8'));
  await db.query(readFileSync(join(root, 'migrations/20260910121120_email_domain_failure_notices.sql'), 'utf8'));
