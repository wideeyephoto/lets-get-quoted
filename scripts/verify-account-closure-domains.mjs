...
try {
  ...
  await db.query(source('20260910143609_account_closure_domain_cleanup.sql'));
  await db.query(source('20260910143620_account_closure_request_contract.sql'));
  await db.query(source('20260910143631_account_closure_actor_type.sql'));
