...
| **CLM-007** | *"Official Intuit QuickBooks Online Direct Accounting Sync."* | `/features`, `/pricing`, `product-truth.ts` | Integration Partner | **Third-Party Proof:** Direct push OAuth 2.0 integration built strictly against official Intuit Developer REST API endpoints (`/v3/company/.../invoice`, `/v3/company/.../customer`). | ✅ **VERIFIED**<br/>Integrations Eng |
