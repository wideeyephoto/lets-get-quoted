...
Prepared September 9; updated September 11, 2026 at 16:46 UTC. Status: **Seven-day observation is active from September 11 at 16:23:14.731206 UTC, with 0/7 qualifying scheduled checks so far. The first in-window Outlook product send, receipt, authentication and matching quote link passed on the PR #78 production release at 16:43–16:46 UTC; both September 11 inbox allowances are now used. Remaining message paths, lifecycle drills, supported website-fixture cleanup and final canary acceptance remain open.** See the [current receipt evidence](contractor-domains-canary-2026-09-09.md#september-11-first-in-window-outlook-receipt).
