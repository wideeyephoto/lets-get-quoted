...
2. R04 domain observation — started September 11 at 16:23:14.731206 UTC (12:23 PM America/New_York); earliest seven-day review September 18 at the same time. **2/7 qualifying scheduled runs and two completed 24-hour observation days as of September 13 16:42 UTC:** runs `27eccf15` and `0644860a` checked the active domain successfully; the September 11 morning run remains pre-start evidence only. The active binding remains verified with zero open notices or unresolved callbacks. In-window Gmail and Outlook quotes passed delivery/authentication/link checks; September 13's Outlook reply selected Gmail and arrived with authentication passing. September 13 Gmail allowance is used; Outlook remains unused. The supported empty website-fixture closure is queued, with its normal October 12 recovery deadline; fixture-only acceleration approval is pending. Remaining lifecycle/cleanup, Gmail reply and visible From mailbox checks still block sign-off. See the [current canary record](contractor-domains-canary-2026-09-09.md#september-13-second-complete-observation-day).
