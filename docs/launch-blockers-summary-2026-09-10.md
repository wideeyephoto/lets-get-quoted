...
2. R04 domain observation — started September 11 at 16:23:14.731206 UTC (12:23 PM America/New_York); earliest seven-day review September 18 at the same time. **2/7 qualifying scheduled email runs and two completed 24-hour observation days as of September 14 00:44 UTC:** runs `27eccf15` and `0644860a` checked the active domain successfully. Retain one website-watcher Gateway Timeout at 00:00 UTC, recovered by the scheduled 00:15 run; active and fixture TLS remain valid. The email binding remains verified with zero open notices or unresolved callbacks, so the original start stands. In-window Gmail and Outlook quotes passed delivery/authentication/link checks; September 13's Outlook reply selected Gmail and arrived with authentication passing. It is still September 13 in New York: Gmail allowance is used; Outlook remains unused. The supported empty website-fixture closure is queued with its normal October 12 recovery deadline; fixture-only acceleration approval is pending. Remaining lifecycle/cleanup, Gmail reply and visible From mailbox checks still block sign-off. See the [current canary record](contractor-domains-canary-2026-09-09.md#september-14-website-watcher-timeout-and-recovery).
