...
`public/audio/dispatch-connected-v1.wav` is an original two-tone cue synthesized
by `node scripts/generate-dispatch-chime.mjs`. It contains no sampled or copied
brand audio. It is 620ms, 24kHz mono 16-bit PCM, with a peak of -14.9dBFS and
rounded attack/release envelopes. The file is 29,804 bytes and served under a
...
protected deployment health, and an unauthenticated GET confirming audio/wav
