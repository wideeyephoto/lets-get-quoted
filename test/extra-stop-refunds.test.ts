...
import { computeCustomerRefundPercent } from '@/lib/extra-stop-refunds';
import type { ExtraStopRequest } from '@/lib/extra-stop-requests';
...
function req(partial: Partial<ExtraStopRequest>): ExtraStopRequest {
  return {
    paid_at: null,
    en_route_at: null,
    arrived_at: null,
