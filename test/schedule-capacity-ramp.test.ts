...
import { CAPACITY_LABEL, CAPACITY_LEVELS, capacityLevel, type CapacityLevel } from '@/lib/schedule-capacity';
...
describe('the month cell is coloured by the band', () => {
  it('computes it once and hangs everything off it', () => {
    expect(MONTH).toContain('capacityLevel({ bookedHours: booked, capacityHours, jobCount: dayJobs.length, markedFull: isFull })');
