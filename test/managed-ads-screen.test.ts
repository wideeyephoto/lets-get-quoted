...
describe('Enhanced Managed Ads Dashboard Screen (/dashboard/marketing/ads)', () => {
  ...
  it('renders comprehensive trust chips and AI recommendation strategy with weekly drip & auto-refill wallet', () => {
    ...
    expect(SCREEN_SRC).toContain('Weekly Drip ($168–$588/wk) or Auto-Refill Wallet');
  ...
  it('renders Closed-Loop Offline Revenue Synchronization telemetry connected to Google Ads API v25', () => {
    ...
    expect(SCREEN_SRC).toContain('Active &amp; Synced with Google Ads API v25');
