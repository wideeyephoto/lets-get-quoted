...
import {
  customerWords,
  extraStopRuleReference,
  screenExtraStopCandidates,
  type CandidateInput,
} from '@/lib/extra-stop-candidates';
...
const screen = (items: CandidateInput[], maxVisitMinutes = 60) =>
  screenExtraStopCandidates(items, { maxVisitMinutes });

describe('screenExtraStopCandidates', () => {
...
describe('extraStopRuleReference', () => {
