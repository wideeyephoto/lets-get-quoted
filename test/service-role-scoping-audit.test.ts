...
describe('Service-Role Scoping & Authorization Sweep', () => {
  ...
  it('scans all server action files and enforces tenant/auth/token guard execution', () => {
    ...
    for (const filePath of actionFiles) {
      ...
      const isPublicGuarded = content.includes('verifyToken') || content.includes('token') || content.includes('turnstile') || content.includes('rateLimit') || content.includes('checkRateLimit') || content.includes('validateCaptcha') || content.includes('verifyJobToken') || content.includes('parseUnsubscribeToken') || content.includes('verifyOtp') || rel.startsWith('login/') || rel.startsWith('field/login/') || rel.startsWith('contact/') || rel.startsWith('book/') || rel.startsWith('claim/') || rel.startsWith('portal/') || rel.startsWith('quick-stop/') || rel.startsWith('invoice/') || rel.startsWith('review/') || rel.startsWith('track/') || rel.startsWith('client/jobs/') || rel.startsWith('unsubscribe/');
