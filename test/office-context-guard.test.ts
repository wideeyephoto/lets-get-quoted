...
describe('the wiring, as source', () => {
  ...
  it('names every surface that has been opened, and no others', () => {
    ...
    expect(callers.sort()).toEqual([
      ...
      'src/app/dashboard/jobs/[id]/forms/[submissionId]/print/page.tsx',
      ...
      'src/app/dashboard/leads/text-actions.ts',
      'src/app/dashboard/marketing/actions.ts',
      'src/app/dashboard/marketing/ads/page.tsx',
      ...
      'src/app/dashboard/merchandise/actions.ts',
      'src/app/dashboard/merchandise/page.tsx',
      ...
      'src/app/dashboard/schedule/requests/page.tsx',
      'src/app/dashboard/schedule/settings/page.tsx',
      'src/app/dashboard/schedule/waitlist/actions.ts',
      'src/app/dashboard/schedule/waitlist/page.tsx',
      ...
      'src/app/dashboard/view-actions.ts',
