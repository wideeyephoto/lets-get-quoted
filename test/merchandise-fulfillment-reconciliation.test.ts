...
const mockAdmin: any = {
  rpc: vi.fn(async (name, args) => { if (name !== "apply_printful_order_event") throw new Error(name); mockOrderUpdatePayloads.push(args.p_updates); return { data: true, error: null }; }),
